                ...
                if (context.watch<OrderDetailController>().refundCount > 0 &&
                  ...
                  BorderContainer(
                    ...
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        RefundedOrderListScreen.routeName,
                        arguments: RefundedOrderListScreen(
          ...
          Expanded(
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: _textForDetailInfoTitle("Note")),
                    Expanded(
                      flex: 2,
                      child: _textForDetailInfo(
                          controller.orderHistory?.note ?? ''),
                    ),
                  ],
                ),
              ],
  ...
  List<DataRow> _productLinesDataRow(OrderDetailController controller) {
    ...
    for (int i = 0; i < (controller.orderHistory?.lineIds ?? []).length; i++) {
      ...
      dataRow.add(DataRow(cells: [
        ...
        DataCell(_textForDetailInfo(data?.packaging ?? '')),
