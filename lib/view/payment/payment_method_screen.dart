        ...
        Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                // context.watch<PaymentMethodListController>().isDetail
                //     ? 'Payment Methods / ${context.read<PaymentMethodListController>().editingPaymentMethod?.name}'
                //     : context.watch<PaymentMethodListController>().isNew
                //         ? 'Payment Methods / New'
                //         :
                'Payment Methods',
...
class DataSourceForPaymentMethodListScreen extends DataTableSource {
  ...
  late List<PaymentMethod> paymentMethodInfoList;
  int offset;
  ...
  void sort<T>(
      Comparable<T> Function(PaymentMethod d) getField, bool ascending) {
  ...
  DataRow _createRow(int index) {
    PaymentMethod paymentMethod = paymentMethodInfoList[index];
    return DataRow(
