...
class RefundedOrderListController with ChangeNotifier {
  ...
  DataSourceForRefundedOrderListScreen? _orderInfoDataSource;
  DataSourceForRefundedOrderListScreen? get orderInfoDataSource =>
      _orderInfoDataSource;
  set orderInfoDataSource(
      DataSourceForRefundedOrderListScreen? orderInfoDataSource) {
